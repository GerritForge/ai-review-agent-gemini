...
### GET /accounts/self/ai-review-agent-gemini~geminiToken

Retrieves the currently set Gemini API token for the user.

**Request:**
```http
  GET /a/accounts/self/ai-review-agent-gemini~geminiToken HTTP/1.0
```
...
**Request:**
```http
  GET /a/accounts/<other-user-accountid>/ai-review-agent-gemini~geminiToken HTTP/1.0
```
